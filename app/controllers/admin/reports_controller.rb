...
class Admin::ReportsController < AdminController
  ...
  def get_date_params
    ...
    # look for parameters
    @start_date = params["start_date"].to_datetime.in_time_zone("Australia/Sydney").midnight if params["start_date"].present?
    @end_date = params["end_date"].to_datetime.in_time_zone("Australia/Sydney").end_of_day if params["end_date"].present?
