...
namespace :sample do
  ...
  task :seed, [:edits] => :environment do |_task, args|
    ...
    seedEdits(transcript, lines) if do_edits
  ...
  def seedEdits(_transcript, lines)
  ...
  def seedLines(transcript)
    ...
    lines << seedLine({ transcript_id: transcript.id, sequence: 3, start_time: 8604, end_time: 10_273, original_text: 'can you tell me more', guess_text: '', text: '', transcript_line_status_id: 1, speaker_id: 0, flag_count: 0 })
    lines << seedLine({ transcript_id: transcript.id, sequence: 4, start_time: 10_276, end_time: 14_560, original_text: 'yah care to start', guess_text: '', text: '', transcript_line_status_id: 1, speaker_id: 0, flag_count: 0 })
    lines << seedLine({ transcript_id: transcript.id, sequence: 5, start_time: 14_793, end_time: 16_343, original_text: 'why do want to show', guess_text: '', text: '', transcript_line_status_id: 1, speaker_id: 0, flag_count: 0 })
    lines << seedLine({ transcript_id: transcript.id, sequence: 6, start_time: 16_711, end_time: 19_168, original_text: 'it\'s a community driven project we start with', guess_text: '', text: '', transcript_line_status_id: 1, speaker_id: 0, flag_count: 0 })
    lines << seedLine({ transcript_id: transcript.id, sequence: 7, start_time: 19_110, end_time: 21_334, original_text: 'with speeched text generation transcripts', guess_text: '', text: '', transcript_line_status_id: 1, speaker_id: 0, flag_count: 0 })
    lines
  end

  def seedSpeaker(attributes)
    Speaker.find_or_create_by(name: attributes[:name])
